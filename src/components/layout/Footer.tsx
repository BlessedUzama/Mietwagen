...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="w-full bg-slate-100 dark:bg-[#020617] text-slate-600 dark:text-slate-400 border-t border-slate-200 dark:border-slate-800/80 pt-16 pb-12 transition-colors duration-300 relative z-10">
